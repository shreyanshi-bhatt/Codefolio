    ...
    <>
      ...
      <div className='w-full flex'>
        <p className='mt-3 text-secondary text-[17px] w-full leading-[30px]'>
          <h3 onClick={() => window.open("https://github.com/shreyanshi-bhatt", "_blank")} className={`${styles.gitHubLink}`}>GitHub: <span className={`${styles.gitHubText}`}>https://github.com/shreyanshi-bhatt</span></h3>
